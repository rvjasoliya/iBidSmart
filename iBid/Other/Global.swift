 ...
 var BundleID = "com.alteso.iBid"
 var appStoreID =  11111111
 var mailId = "test@gmail.com"
 var appFullName = "iBid"
 var ShareLinkMsg = "\(appFullName) \n\n Downlaod : https://itunes.apple.com/app/id\(appStoreID)"
 
 public func showLoading(string: String?, maskType: SVProgressHUDMaskType = SVProgressHUDMaskType.black) {
     SVProgressHUD.setDefaultMaskType(SVProgressHUDMaskType.black)
     SVProgressHUD.show(withStatus: string  ?? "")
 }
 
 public func dissmissLoader(){
...
//        let when = DispatchTime.now()
 ...
 func toastMsg(vc:UIViewController?, msg:String?){
    vc?.view.makeToast(msg ?? "", duration: 2.0, position: .bottom)
 }
